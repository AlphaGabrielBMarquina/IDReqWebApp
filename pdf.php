...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row p-0 p-sm-1 p-md-2 p-lg-4">
          <div class="card col-md-12 mt-2" id="pi">
    ...
    <div class="container-fluid text-right mt-3 mb-3">
        <div class="text-right">
          <a href="#" class="btn btn-danger" role="button" onclick="window.print()" id="pr">Save Info as PDF</a>
          <a href="#" class="btn btn-danger" role="button">Save Picture</a>
        </div>
    </div>
    <!-- Modal -->
  ...
  <footer class="site-footer" style="background-color: gray;" id="ft">
    <div class="container-fluid">
      <div class="row">
